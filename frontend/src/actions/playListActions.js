...
const addPLtoPLA = (playListTitle) => async (dispatch, getState) => {
  ...
  try {
    ...
    await axios.put(`${REACT_APP_SERVER_URL}/api/playlists`, playList, config)
...
const removePLfromPLA = (playListTitle) => async (dispatch, getState) => {
  try {
    ...
    await axios.delete(`${REACT_APP_SERVER_URL}/api/playlists/${playListTitle}`, config)
...
const addSongToPL =
  (movieTitle, songName, playListTitle) => async (dispatch, getState) => {
    ...
    try {
      ...
      await axios.put(`${REACT_APP_SERVER_URL}/api/playlists/${playListTitle}`, plSong, config)
...
const removeSongFromPL =
  (songName, playListTitle) => async (dispatch, getState) => {
    try {
      ...
      await axios.delete(`${REACT_APP_SERVER_URL}/api/playlists/${playListTitle}/${songName}`, config)
...
const listPlayLists = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${REACT_APP_SERVER_URL}/api/playlists`, config)
...
const detailsPlayList = (playListTitle) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${REACT_APP_SERVER_URL}/api/playlists/${playListTitle}`, config)
