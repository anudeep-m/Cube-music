...
const listAlbums = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${process.env.REACT_APP_SERVER_URL}/api/albums`)
...
const detailsAlbum = (movieTitle) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${process.env.REACT_APP_SERVER_URL}/api/albums/${movieTitle}`)
...
const detailsAlbumFA = (movieId) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_SERVER_URL}/api/albums/admin/movie/${movieId}`,
      config
    )
...
const albumAdd = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${process.env.REACT_APP_SERVER_URL}/api/albums/admin`, {}, config)
...
const albumEdit =
  (movieId, movieTitle, moviePoster) => async (dispatch, getState) => {
    ...
    try {
      ...
      await axios.put(`${process.env.REACT_APP_SERVER_URL}/api/albums/admin/movie/${movieId}`, album, config)
...
const albumDelete = (movieId) => async (dispatch, getState) => {
  try {
    ...
    await axios.delete(`${process.env.REACT_APP_SERVER_URL}/api/albums/admin/movie/${movieId}`, config)
...
const detailsSongFA = (movieId, songId) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_SERVER_URL}/api/albums/admin/song/${movieId}/${songId}`,
      config
    )
...
const songDelete = (movieId, songId) => async (dispatch, getState) => {
  try {
    ...
    await axios.delete(`${process.env.REACT_APP_SERVER_URL}/api/albums/admin/song/${movieId}/${songId}`, config)
